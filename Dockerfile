...
RUN wget 'https://archive.cloudera.com/cdh5/ubuntu/trusty/amd64/cdh/cloudera.list' -O /etc/apt/sources.list.d/cloudera.list && \
    ...
    sudo apt-get update && \
    sudo apt-get -y install hadoop-hdfs-datanode=2.6.0+cdh5.8.0+1601-1.cdh5.8.0.p0.93~trusty-cdh5.8.0 && \
    sudo apt-get -y install hadoop-yarn-nodemanager=2.6.0+cdh5.8.0+1601-1.cdh5.8.0.p0.93~trusty-cdh5.8.0
